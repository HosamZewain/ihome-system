...
export default function CreateQuotation() {
    ...
    const handleSubmit = () => {
        ...
        const quotation: Omit<Invoice, 'id' | 'createdAt' | 'invoiceNumber'> = {
            type: 'quotation',
            customer,
            items,
            subtotal,
    ...
    return (
        <div className="sales-page create-invoice-container">
            ...
            <div className="page-header">
                <div>
                    <button onClick={() => navigate('/sales/quotations')} className="btn btn-ghost btn-sm" style={{ marginBottom: '0.5rem' }}>
                        ← Back to Quotations
                    </button>
                    <h1 className="page-title">Create New Quotation</h1>
                </div>
                <div className="flex gap-3">
                    <button onClick={() => navigate('/sales/quotations')} className="btn btn-secondary">
                        Cancel
                    </button>
                    <button onClick={handleSubmit} disabled={items.length === 0 || !customerName} className="btn btn-primary">
                        Save Quotation
                    </button>
                </div>
            </div>
            ...
            <div className="invoice-layout">
                ...
                <div className="invoice-main-column">
                    ...
                    <div className="invoice-card">
                        <div className="invoice-card-header">
                            <h3 className="card-title">Quotation Items</h3>
                    ...
                    <div className="invoice-card invoice-summary-card">
                        <div className="invoice-card-body">
                            ...
                            <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                                ...
                                <textarea className="form-input" rows={3} value={notes} onChange={(e) => setNotes(e.target.value)} placeholder="Terms, thank you note..." />
                            </div>
